...
namespace _04_Loops
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    {
            //        count++;
            //        Console.WriteLine(i); // 50' den küçük ve ya eşit olan sayıların hangisinin 7' ye bölündüğünü gösterir

            //    }
            //}
            //Console.WriteLine(count); // 50' den küçük ve ya eşit olan sayılardan toplam da kaç sayı 7'ye bölünmüş onu gösterir.
